...
def analyze_with_gemini(text, filename):
    ...
    prompt = (
        ...
        "- In ANTET: 'Facture pour' = CLIENTUL (firma de conciergerie sau persoana care plateste)\n"
        "- In TABEL 'Detail des prestations': coloana 'Nom' = numele CASEI/PROPRIETATII\n\n"
        "REGULI OBLIGATORII:\n"
        "1. proprietate = DOAR numele din coloana 'Nom' din tabel (ex: Antoniotti, Villa Marina, Glas)\n"
        "   IGNORA orice adrese, coduri postale, nume de strazi, orase\n"
        "   IGNORA: 'Macchia Di Cervi', 'Route de l'Ancienne Voie', 'San-Gavino', 'Porto-Vecchio' etc.\n"
